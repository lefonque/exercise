...
public class LengthFieldStringFrameDecoder extends FrameDecoder {
     ...
     */
    public LengthFieldStringFrameDecoder(
            int maxFrameLength,
...
//        }
	...
	protected Object decode(
        ...
        byte[] lengthValueInBytes = new byte[lengthFieldLength];
        buffer.getBytes(actualLengthFieldOffset, lengthValueInBytes);
        String lengthValueInString = new String(lengthValueInBytes);
        if(!NumberUtils.isNumber(lengthValueInString)){
        	throw new Error("should not reach here");
        }
        long frameLength = NumberUtils.toLong(lengthValueInString);
